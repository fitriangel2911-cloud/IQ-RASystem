    ...
    <div style={{ minHeight: '100vh', display: 'flex', background: 'transparent', position: 'relative', overflow: 'hidden' }}>
      ...
      <aside style={{
        ...
        <div style={{ 
          ...
          <div style={{ color: 'var(--text-secondary)', fontSize: '11px', fontWeight: 800, textTransform: 'uppercase', marginBottom: '6px' }}>Anggota Dewan DPS</div>
          <div style={{ color: 'var(--text-primary)', fontWeight: 900, fontSize: '18px' }}>{profile?.full_name}</div>
          <div style={{ color: 'var(--text-secondary)', fontSize: '12px', fontWeight: 600 }}>Hak Akses: Auditor Syariah</div>
      ...
      <main style={{ 
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px' }}>
          ...
          <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border-primary)', color: 'var(--text-primary)', padding: '12px 24px', borderRadius: '14px', fontSize: '14px', fontWeight: 900, boxShadow: '0 4px 15px var(--shadow-color)' }}>
